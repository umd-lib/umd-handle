...
class HandlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create handle" do
    assert_difference('Handle.count') do
      post handles_url, params: { handle: { description: @handle.description, notes: @handle.notes, prefix: @handle.prefix, repo: @handle.repo, repo_id: @handle.repo_id, suffix: @handle.suffix, url: @handle.url } }
    end
  ...
  test "should update handle" do
    patch handle_url(@handle), params: { handle: { description: @handle.description, notes: @handle.notes, prefix: @handle.prefix, repo: @handle.repo, repo_id: @handle.repo_id, suffix: @handle.suffix, url: @handle.url } }
